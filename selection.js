const Selection = (function () {
    ...
    function _selection() {
        ...
        const printConfig = {
            icon:
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" enable-background="new 0 0 24 24" width="24" height="24" class="selection__icon"><g id="surface1"><path style=" stroke:none;fill-rule:nonzero;fill:rgb(100%,100%,100%);fill-opacity:1;" d="M 6 18.75 L 6 23.25 L 18 23.25 L 18 15.75 L 6 15.75 Z M 7.5 17.25 L 16.5 17.25 L 16.5 18.75 L 7.5 18.75 Z M 7.5 20.25 L 16.5 20.25 L 16.5 21.75 L 7.5 21.75 Z M 7.5 20.25 "/><path style=" stroke:none;fill-rule:nonzero;fill:rgb(100%,100%,100%);fill-opacity:1;" d="M 18 5.25 L 18 0.75 L 6 0.75 L 6 8.25 L 18 8.25 Z M 18 5.25 "/><path style=" stroke:none;fill-rule:nonzero;fill:rgb(100%,100%,100%);fill-opacity:1;" d="M 21 5.25 L 19.5 5.25 L 19.5 9.75 L 4.5 9.75 L 4.5 5.25 L 3 5.25 C 1.5 5.25 0 6.75 0 8.25 L 0 15.75 C 0 17.25 1.5 18.75 3 18.75 L 4.5 18.75 L 4.5 14.25 L 19.5 14.25 L 19.5 18.75 L 21 18.75 C 22.5 18.75 24 17.25 24 15.75 L 24 8.25 C 24 6.75 22.5 5.25 21 5.25 Z M 21 5.25 "/></g></svg>'
        };
        ...
        function printButton() {
            const prtbtn = new Button(printConfig.icon, function () {
        ...
        function appendIcons() {
            ...
            { feature: 'copy', call: copyButton() }, { feature: 'speak', call: speakButton() }, { feature: 'print', call: printButton() }]
        ...
        function config(options) {
            ...
            menu.print = options.print === undefined ? menu.print : options.print;
