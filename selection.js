  ...
  function Selection() {
    ...
    function facebookButton(){
        const fbbtn = new Button(facebookConfig.icon,function(){
          ...
          var finalurl = facebookConfig.url
    ...
    function config(options) {
      menu.twitter = options.twitter === undefined
                          ? menu.twitter
                          : options.twitter
      menu.facebook = options.facebook === undefined
                           ? menu.facebook
                           : options.facebook
      menu.search = options.search === undefined
                           ? menu.search
                           : options.search

      menu.copy = options.copy === undefined
                           ? menu.copy
                           : options.copy
      menu.speak = options.speak === undefined
                           ? menu.speak
                           : options.speak

      menu.disable = options.disable === undefined
                           ? menu.disable
                           : options.disable
