const Selection = (function() {
  ...
  function _selection() {
    ...
    function facebookButton() {
      const fbbtn = new Button(facebookConfig.icon, facebookConfig.title, function() {
    ...
    function twitterButton() {
      ...
      const twbtn = new Button(twitterConfig.icon, twitterConfig.title, function() {
    ...
    function searchButton() {
      const searchbtn = new Button(searchConfig.icon, searchConfig.title, function() {
    ...
    function copyButton() {
      const cbtn = new Button(copyConfig.icon, copyConfig.title, function() {
    ...
    function speakButton() {
      const spbtn = new Button(speakConfig.icon, speakConfig.title, function() {
