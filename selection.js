const Selection = (function () {
  ...
  function _selection() {
    ...
    function appendIcons() {
      ...
      myitems.forEach((item) => {
        if (menu[item.feature]) {
          fragment.appendChild(item.call);
        }
      });
      div.append(fragment);
      return {
        icons: div,
        length: div.childElementCount,
      };
    }
    ...
    function config(options) {
      ...
      menu.facebook =
        options.facebook === undefined ? menu.facebook : options.facebook;
      menu.search = options.search === undefined ? menu.search : options.search;
      menu.translate =
        options.translate === undefined ? menu.translate : options.translate;
